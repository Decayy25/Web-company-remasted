...
export default function Informasi () {
    ...
    return (
    <>
        <section id="informasi" className="py-20">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center" data-aos="fade-up">Informasi Sekolah</h2>
            
            {/* Menggunakan Flex-Col agar di HP bertumpuk di tengah */}
            <div className="flex flex-col lg:flex-row items-center justify-center gap-12 px-6 max-w-7xl mx-auto">
                
                {/* Bagian Kiri (4 Kotak): Tetap ukurannya, tapi center */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center">
                    {members.map((member, i) => (
                        ...
                        >
                            {/* Ukuran tetap w-48 mx-auto agar selalu di tengah */}
                            <div 
                ...
                {/* Bagian Kanan (Kotak Besar): Tetap ukurannya, tapi center */}
                <div 
                    ...
                    <div className="shadow-lg rounded-lg overflow-x-auto">
                        <table className="min-w-full">
                            <tbody>
                                ...
                                <tr><td className="py-2 px-4 border-b">Nama</td><td className="py-2 px-4 border-b">SMKS MA ARIF TERPADU</td></tr>
                                <tr><td className="py-2 px-4 border-b">Status</td><td className="py-2 px-4 border-b">SWASTA</td></tr>
                                <tr><td className="py-2 px-4 border-b">Alamat</td><td className="py-2 px-4 border-b">JL. DEWI SARTIKA NO.119</td></tr>
                                <tr><td className="py-2 px-4 border-b">Kecamatan</td><td className="py-2 px-4 border-b">Kec. Cicalengka</td></tr>
                                <tr><td className="py-2 px-4 border-b">Kabupaten</td><td className="py-2 px-4 border-b">Kab. Bandung</td></tr>
