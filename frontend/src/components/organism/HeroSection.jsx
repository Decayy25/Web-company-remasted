...
export default function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen overflow-hidden bg-[#020617] flex items-center py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        <div className="content text-center md:text-left order-2 md:order-1">
          <Title>SMK Ma'arif Terpadu Cicalengka</Title>
          <p className="mt-6 text-slate-400 text-lg md:text-2xl italic font-medium">
            “𝘒𝘶𝘯𝘤𝘪 𝘚𝘶𝘬𝘴𝘦𝘴 𝘢𝘥𝘢𝘭a𝘩 𝘉𝘦𝘭𝘢𝘫𝘢𝘳”
          </p>
          <p className="mt-4 text-slate-400 text-base md:text-lg lg:text-xl max-w-xl mx-auto md:mx-0">
            Temukan potensi skill anda bersama sekolah yang mendukung, tutorial interaktif, dan sumber daya berkualitas tinggi.
          </p>
          <Button variant="primary" className="mt-8">Pelajari Lebih Lanjut</Button>
        </div>
